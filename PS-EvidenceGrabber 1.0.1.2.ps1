...
#Suppresses errors when logging. Some CMDs do not run on earlier versions of Windows and throw errors.

$ErrorActionPreference= 'silentlycontinue'

#Set-PSDebug -Trace 1 - used for debugging
...
##The Get-PNPDevice CMDlet only works on Win 10 / Win server 2016 and onwards. It will throw an error message on earlier version of windows.
